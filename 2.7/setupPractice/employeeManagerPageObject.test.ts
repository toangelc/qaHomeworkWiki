...
test("adding Employees", async () => {
    ...
    await emPage.setInput(emPage.nameField, "Hayden James")
    await emPage.setInput(emPage.phoneField, "8018776224")
    await emPage.setInput(emPage.titleField, "Copywriter")
